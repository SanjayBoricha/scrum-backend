...
Route.group(() => {
  ...
  Route.patch('tasks/:id/change-status', 'TasksController.changeStatus')
  Route.patch('tasks/:id/change-prirority', 'TasksController.changePriority')
  Route.patch('tasks/:id/change-assingee', 'TasksController.changeAssignee')
  Route.patch('tasks/:id/change-due-date', 'TasksController.changeDueDate')
  Route.patch('tasks/:id/change-type', 'TasksController.changeType')
